...
\author{Parth Sinha\\
  \textit{Affiliation to be supplied}\\
...
\todo[inline]{Title page: replace the affiliation placeholder with institution,
city and country, or with ``Independent researcher''.}
